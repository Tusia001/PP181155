/* LAB Napisz funkcjê printListWithoutHead, która przyjmuje jako argument listê bez g³owy o elementach typu:
struct element {
    int x;
    struct element * next;
};

Funkcja ma wyœwietliæ kolejne elementy listy w kolejnych wierszach lub wyœwietliæ komunikat, ¿e lista jest pusta. Stwórz przypadek testowy. */
