/* EGZAMIN/URYWKI KOLOS/LAB Napisz strukturê Computer z polami manufacturer (tablica znaków d³ugoœci 30) oraz usage_hours (typu int). Nastêpnie napisz dwie funkcje i wywo³aj ka¿d¹ z nich co najmniej jeden raz:
    a. initComputer - funkcja przyjmuje dwa argumenty: producenta i liczbê godzin u¿ywania, i zwraca wskaŸnik na nowo utworzon¹ strukturê, 
    ustawiaj¹c wartoœci zgodnie z przekazanymi argumentami. Funkcja powinna tak¿e sprawdzaæ, czy nazwa producenta ma co najmniej 2 znaki i 
    liczba godzin jest wiêksza od 0. Jeœli oba warunki nie s¹ spe³nione ³¹cznie, funkcja powinna zwracaæ NULL.
